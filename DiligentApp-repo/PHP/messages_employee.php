...
<body>
  ...
  <style>
    <?php include 'CSS/messages_employee.css';
    ?>
  </style>
  ...
  <div class="contenido">
    ...
    <main>
      <div class="top-user">
        ...
        <button class="sent-btn" type="button"><span><i class="fas fa-envelope"></i></span><a href="messages2_employee.php"> See Sent Messages</a></button>
      ...
      <section class="List">
        <div class="empleados-grid">
          ...
          <div>
          <h3><span><i class="fas fa-inbox"></i></span>Inbox Messages</h3>
          </div>
